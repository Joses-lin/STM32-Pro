...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, DB02_Pin|DB03_Pin|DB04_Pin|DB05_Pin
  ...
  /*Configure GPIO pins : DB02_Pin DB03_Pin DB04_Pin DB05_Pin
                           DB06_Pin DB07_Pin DB08_Pin DB09_Pin
                           DB10_Pin DB11_Pin DB12_Pin DB13_Pin
                           DB14_Pin DB15_Pin DB00_Pin DB01_Pin */
  GPIO_InitStruct.Pin = DB02_Pin|DB03_Pin|DB04_Pin|DB05_Pin
                          |DB06_Pin|DB07_Pin|DB08_Pin|DB09_Pin
                          |DB10_Pin|DB11_Pin|DB12_Pin|DB13_Pin
                          |DB14_Pin|DB15_Pin|DB00_Pin|DB01_Pin;
  ...
  /*Configure GPIO pins : Wakeup_Pin USB_ID_Pin */
  GPIO_InitStruct.Pin = Wakeup_Pin|USB_ID_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : USB_PWR_Pin F_CS_Pin */
  GPIO_InitStruct.Pin = USB_PWR_Pin|F_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
